...
var optimizeWebpackImages = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(throttle, compilation, testRegexes, minFileSize, maxFileSize, imageminOptions, overwriteExt) {
    var _this2 = this;
          ...
          case 0:
            return _context3.abrupt('return', _promise2.default.all((0, _lodash2.default)(compilation.assets, function (asset, filename) {
              return throttle((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
                var assetSource, optimizedImageBuffer, filext, basename, newFilename;
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 4:
                        ...
                        filext = _path2.default.extname(filename);
                        basename = _path2.default.basename(filename, filext);
                        newFilename = `${basename}${overwriteExt ? overwriteExt : filext}`;


                        compilation.assets[newFilename] = new _RawSource2.default(optimizedImageBuffer);
  ...
  return function optimizeWebpackImages(_x4, _x5, _x6, _x7, _x8, _x9, _x10) {
...
var optimizeExternalImages = function () {
  var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(throttle, sources, destination, minFileSize, maxFileSize, imageminOptions) {
    var _this3 = this;
  ...
  return function optimizeExternalImages(_x11, _x12, _x13, _x14, _x15, _x16) {
...
var optimizeImage = function () {
  var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(imageData, imageminOptions) {
  ...
  return function optimizeImage(_x17, _x18) {
...
var readFile = function () {
  var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(filename) {
...
var exists = function () {
  var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(directory) {
...
var writeFile = function () {
  var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(filename, buffer) {
  ...
  return function writeFile(_x21, _x22) {
  ...
  function ImageminPlugin() {
    ...
    var _options$disable = options.disable,
      ...
      destination: null
        ...
        _options$webp = options.webp,
        webp = _options$webp === undefined ? null : _options$webp;
    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('emit', function () {
        var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(compilation, callback) {
          var throttle, work, imageminOptions;
          return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 9:
                  _context.prev = 9;
                  work = [optimizeWebpackImages(throttle, compilation, testRegexes, minFileSize, maxFileSize, _this.options.imageminOptions), optimizeExternalImages(throttle, sources, destination, minFileSize, maxFileSize, _this.options.imageminOptions)];
                  ...
                  _context.next = 14;
                  return _promise2.default.all(work);
